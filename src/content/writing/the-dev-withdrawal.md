...
seo:
  ...
  description: "A personal reflection on finishing Crona, the strange emptiness that follows a long
    build cycle, and the habit developers form around always needing the next thing to make"
---
...
__Coffee. Editor. Terminal__.

I opened the repository and just stared at it. _There was nothing left to build_. 

Sure there are bugs, A feature request here and there. A bit of tech debt I'd been ignoring, but majority of the work was done.

For months, every spare minute was dedicated to this. Every commute, every walk somehow turned into an architecture discussion with myself.
Suddenly all of that fell silent, I'd gotten so used to the daily chaos that the stability felt wrong.

I'd started looking for problems to fix. 
...
To be honest, I don't have an answer, over the last few days my mind has been working overtime to find the next thing the becomes my routine,
new tools to build, weird experiments I can do, rebuilding my portfolio, even writing this blog.

Part of me realise it's just another way to avoid the silence. To replace one obsession with another.
